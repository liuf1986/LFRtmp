...
NSString *const LFBeautifulFilterString = SHADER_STRING
                                                        (
...
@implementation LFBeautifulFilter
{
...
- (id)init{
    self = [super initWithFragmentShaderFromString:LFBeautifulFilterString];
    if (self){
        _toneLevel = 0.5;
        _beautyLevel = 0.5;
        _brightLevel = 0.5;
